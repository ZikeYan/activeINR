...
def get_colormap(sdf_range=[-2, 2], surface_cutoff=0.01):
    ...
    norm = mpl.colors.Normalize(-1,1)#sdf_range[0], sdf_range[1])

    sdf_cmap_fn = cm.ScalarMappable(norm=norm, cmap=mpl.cm.twilight_shifted)#sdf_cmap)
...
#     """
#     from activeINR.visualisation import sdf_viewer
